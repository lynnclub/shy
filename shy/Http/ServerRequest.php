...
class ServerRequest implements ServerRequestInterface
{
    ...
    {
        return $name . ': ' . $this->request->headers->get($name);
    }
    ...
    {
        $this->request->cookies->replace($cookies);
    ...
    {
        $this->request->attributes->get($name, $default);
    }
    ...
    {
        $this->request->attributes->remove($name);
