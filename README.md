...
**框架目前是初始版本，在不断的优化、完善之中，后续更新可能涉及大范围调整，仅供学习参考。**
...
**本框架除了支持传统的web服务运行方式，还支持 常驻内存模式 运行、即进程复用不销毁。该模式由于去掉了重复编译的消耗，性能相对于传统web方式大幅度提升。**

### 1.2 特性列表

* 容器
* 异常、错误处理
* 组件式设计、模块化分离、适配器模式（暂未实现）
* 流水线
* 中间件
* 请求
* 响应
